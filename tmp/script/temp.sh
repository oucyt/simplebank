...
# https://github.com/protocolbuffers/protobuf/releases/download/v24.0/protoc-24.0-linux-x86_64.zip"
...
if [ ! -f /usr/local/protoc/bin/protoc ]; then
    ...
    protoc_url="https://github.com/ktr0731/evans/releases/download/v0.10.11/evans_linux_amd64.tar.gz"
